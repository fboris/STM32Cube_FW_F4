/**
  @page FatFs_RAMDisk_RTOS   FatFs with RAM disk drive in RTOS mode example
  ...
  * @version V1.1.0
  * @date    26-June-2014
  * @brief   Description of the FatFs with RAM disk drive in RTOS mode example
  ******************************************************************************
  *
...
application exploiting FatFs offred features with RAM disk (SRAM) drive in RTOS 
mode configuration. 
